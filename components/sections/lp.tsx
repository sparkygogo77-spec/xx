  ...
  return (
    <div className="p-8 space-y-6">
      <div className="flex items-center gap-3 mb-8">
        <h1 className="text-3xl font-bold text-[#00ff00]">LIQUIDITY POSITIONS</h1>
      </div>
      ...
      >
        ...
        <p className="text-[#a0aec0]">No liquidity positions found. Ensure you have the correct wallet selected.</p>
        ...
        <div className="text-sm text-[#a0aec0] space-y-2">
          <p>Can't find an LP token you're looking for?</p>
          <p>
            It may be in the <span className="text-[#00ff00]">"Unknown"</span> tab accessed by enabling pro mode on the
            bottom left.
          </p>
          <p className="text-xs text-[#718096]">
            This happens when we can't fetch the metadata for the LP token and hide it to prevent accidental burns.
          </p>
        </div>
      </div>
    </div>
